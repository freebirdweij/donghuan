...
public class AccessControlSystem extends Device {
     ...
     */
    public AccessControlSystem(String id, String name, String location, String status, boolean accessGranted, LocalDateTime lastAccessTime, String lastAccessPerson) {
    ...
    @Override
    public void monitor() {
        logger.info("Monitoring Access Control System: {}", getName());
