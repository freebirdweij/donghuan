...
public class CCTVSystem extends Device {
     ...
     */
    public CCTVSystem(String id, String name, String location, String status, boolean recording, String lastRecordingTime) {
    ...
    @Override
    public void monitor() {
        logger.info("Monitoring CCTV System: {}", getName());
